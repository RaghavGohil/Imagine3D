...
int main() {
    ...
    Shader renderTexture("shaders/render_texture.vert","shaders/render_texture.frag");
    ...
    Shader shaderSingleColor("shaders/outline.vert","shaders/outline.frag");
